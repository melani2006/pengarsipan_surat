...
@section('content')
    <x-breadcrumb
        :values="['Transaksi', 'Surat Masuk', 'Edit Surat']">
    </x-breadcrumb>
    ...
    <div class="card mb-4">
        <form action="{{ route('transaksi.masuk.update', $data) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body row">
                ...
                <div class="col-sm-12 col-12 col-md-6 col-lg-4">
                    <x-input-form :value="$data->pengirim" name="pengirim" label="Pengirim"/>
                </div>
                <div class="col-sm-12 col-12 col-md-6 col-lg-4">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="kategori_code" name="kategori_code">
                            @foreach($kategoris as $kategori)
                                <option @selected(old('kategori_code', $data->kategori_code) == $kategori->code)
                                        value="{{ $kategori->code }}">
                                    {{ $kategori->type }}
                                </option>
                            @endforeach
